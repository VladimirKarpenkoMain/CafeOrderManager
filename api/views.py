...
class UpdateOrderStatusView(APIView):
    ...
    def patch(self, request, order_id):
        ...
        Если заказ уже оплачен, статус не может быть изменен.
        """
...
class DeleteOrderView(APIView):
    ...
    def delete(self, request, order_id):
        ...
        Удаление невозможно, если статус заказа "оплачен" или "выполнен".
        """
        order = get_object_or_404(Order, id=order_id)  # Получаем заказ
...
class UpdateRevenueView(APIView):
    ...
    Вызывает логику RevenueUpdater.update_revenue().
    """
